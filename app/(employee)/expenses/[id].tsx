  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        {/* Recall note (if previously recalled) */}
        {expense.recall_note && (
        ...
        {/* Submitted — Recall button */}
        {isSubmitted && (
          <TouchableOpacity
            style={styles.recallBtn}
            onPress={() => setRecallModalVisible(true)}
          >
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalSubtitle}>
              This will move the expense back to Draft so you can edit and resubmit it.
            </Text>
            ...
            <TextInput
              ...
              placeholder="e.g. Wrong date, incorrect amount, added missing receipt..."
              placeholderTextColor={Colors.textMuted}
              multiline
              autoFocus
            />
            <View style={styles.modalButtons}>
              <TouchableOpacity
                ...
                onPress={() => { setRecallModalVisible(false); setRecallNote(''); }}
              >
                <Text style={styles.saveBtnText}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.button, styles.recallConfirmBtn]}
