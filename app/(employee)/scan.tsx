  ...
  if (!hasPermission) {
    return (
      <SafeAreaView style={styles.permissionContainer}>
        ...
        <TouchableOpacity onPress={() => router.push('/(employee)/expenses/new')} style={styles.skipBtn}>
      ...
      <View style={styles.controls}>
        ...
        {isProcessing ? (
          ...
          <>
            ...
            <TouchableOpacity style={styles.manualBtn} onPress={() => router.push('/(employee)/expenses/new')}>
...
// ─── Export correct version for platform ─────────────────────────────────────
...
const styles = StyleSheet.create({
  ...
  scanFrame: {
    width: '88%', height: 260, borderWidth: 2.5,
    borderColor: Colors.white, borderRadius: BorderRadius.md, backgroundColor: 'transparent',
  },
